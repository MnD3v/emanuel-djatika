...
import BlogContent from "@/app/compents/BlogContent";
import AppBar from "@/app/compents/app_bar";
    ...
    try {
        ...
        return (
            <div className="min-h-screen bg-background">
                <AppBar fixed={true} logo={"/logo.png"} menuIcon="/icons/white-menu.png" ></AppBar>
